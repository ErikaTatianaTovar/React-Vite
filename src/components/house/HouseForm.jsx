      ...
      >
        ...
        <div className="mb-4">
          ...
          <select
            ...
            defaultValue={selectedDepartment} //seteando bogota como predeterminado
            className="shadow appearance-none border rounded w-full focus:shadow-outline bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
          >
